...
class Main(tk.Frame):
    ...
    def init_main(self):
        ...
        self.add_img = tk.PhotoImage(file="1.png")
        bth_open_dialog = tk.Button(toolbar, bg="#d7d8e0",bd=0,
                                    image=self.add_img,
                                    command=self.open_dialog)
        bth_open_dialog.pack(side=tk.LEFT )
        ...
        self.update_img = tk.PhotoImage(file='2.png')
...
class ChildW(tk.Toplevel):
    ...
    def init_child(self):
        ...
        label_mail = tk.Label(self,text='E-mail')
...
class Update(ChildW):
    ...
    def init_edit(self):
        ...
        btn_edit.place
        btn_edit.blind("<Button-1>", lambda event:
...
class Search(tk.Toplevel):
    ...
    def init_search(self):
        ...
        btn_cancel = ttk.Button(self, text="Закрыть",command=self)  
        #не дописал
class DB:
    def __init__(self):
